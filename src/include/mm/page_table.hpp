...
namespace PageAttr {
    ...
    static constexpr u64 ATTR_DEVICE    = (0ULL << ATTR_IDX_SHIFT);  ///< 属性索引0: 设备内存
    static constexpr u64 ATTR_NORMAL    = (1ULL << ATTR_IDX_SHIFT);  ///< 属性索引1: 普通缓存内存
    static constexpr u64 ATTR_NORMAL_NC = (2ULL << ATTR_IDX_SHIFT);  ///< 属性索引2: 非缓存内存
...
namespace PagePerms {
    ...
    static constexpr u64 KERNEL_RO = PageAttr::VALID | PageAttr::AF | PageAttr::ATTR_NORMAL |
                                     PageAttr::READONLY | PageAttr::PXN | PageAttr::XN;
     ...
     * - 安全: NX位防止代码注入攻击
     */
    static constexpr u64 KERNEL_RW = PageAttr::VALID | PageAttr::AF | PageAttr::ATTR_NORMAL |
     ...
     * - 安全: W^X原则，代码区不可写
     */
    static constexpr u64 KERNEL_RX = PageAttr::VALID | PageAttr::AF | PageAttr::ATTR_NORMAL |
                                     PageAttr::READONLY;
...
struct [[gnu::packed]] PageTableEntry {
    ...
    constexpr void set_table(PhysAddr next_table_pa) {
        raw = (next_table_pa & 0x0000FFFFFFFFF000ULL) |
              PageAttr::VALID | PageAttr::TABLE;
    }
    ...
    constexpr void set_block(PhysAddr block_pa, u64 attributes) {
        raw = (block_pa & 0x0000FFFFFFFFF000ULL) |
              attributes | PageAttr::VALID;
    }
...
private:
    ...
    static constexpr usize MAX_EARLY_TABLES = 1024;  // 增加到1024个页表（4MB）支持4级页表
