...
static auto test_error_handling = "error_handling"_test = [] {
  ...
  expect_error_code(static_cast<int>(kernel_error_code::invalid_argument), kernel_error_code::invalid_argument);
  expect_error_code(static_cast<int>(kernel_error_code::out_of_memory), kernel_error_code::out_of_memory);
