...
export module moss.drivers.timer;

import moss.std;
import moss.types;
import moss.platform;

export namespace moss::kernel::drivers::timer {
...
inline void configure_local_timer(bool masked) noexcept {
  // Intel SDM: divide configuration 0x3 selects /16; LVT bit 16 masks delivery.
  *reinterpret_cast<volatile u32 *>(platform::intc_dist_base() + 0x3E0) = 3;
  *reinterpret_cast<volatile u32 *>(platform::intc_dist_base() + 0x320) = 48 | (masked ? 1U << 16 : 0);
}
...
} // namespace moss::kernel::drivers::timer
