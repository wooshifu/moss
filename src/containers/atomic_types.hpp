...
private:
  static constexpr moss::kernel::usize MAX_CPUS_PADDED =
      ((moss::kernel::MAX_CPUS + moss::kernel::CACHE_LINE_SIZE - 1) /
       moss::kernel::CACHE_LINE_SIZE) *
      moss::kernel::CACHE_LINE_SIZE;
