...
| MOSS-005 | P0 | 启动保留区未排除 | 多 bank、保留洞、非对齐/重叠、容量/溢出及耗尽已验证；x64 PVH 非 RAM 保留及溢出拒绝有真实启动验收（3.47～3.48）；低地址启动区仍保守保留，完整保留集合/回收及其他 PVH 异常表待补。 |
