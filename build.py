...
def main(
    ctx: typer.Context,
    arch: Optional[str] = typer.Option(None, "--arch", "-a", help="🏗️ 目标架构"),
    build_type: Optional[str] = typer.Option(None, "--build-type", help="🔨 构建类型"),
    preset: Optional[str] = typer.Option(None, "--preset", "-p", help="🎯 指定预设"),
