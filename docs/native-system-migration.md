...
1. Close process-service recovery first. Fault injection showed that an old
   ...
   target domains in the same scope. Exercise old badged senders, pending
   calls and orphaned exit records under concurrent service loss.
