...
- Benchmarks: allocation-only, release-only, combined allocation/release, 256-byte real file reads, and userspace getpid round trips. Timing uses validated ARM64 CNTFRQ/CNTVCT, RISC-V 64 DTB timebase/time, and x86 TSC with three PIT-channel-0 calibration samples in this QEMU profile.
...
| RISC-V 64 | 2147483648 | 519069 |
| x64 | 2147085312 | 519316 |
...
| `build/validation-riscv64-debug` | `1788633598967712000` | `1788633602871610000` | n/a |
| `build/validation-x64-debug` | `1788633600212543000` | `1788633604137171000` | n/a |
| `build/validation-arm64-release` | `1788632788572052000` | `1788632791807099000` | `1788632804450431000` |
| `build/validation-riscv64-release` | `1788632879202825000` | `1788632882038116000` | `1788632894772353000` |
| `build/validation-x64-release` | `1788632955694399000` | `1788632958599602000` | `1788632971594061000` |
