# RISC-V 64位架构配置 支持 RV64I, RV64IM, RV64GC 等变体
...
# RISC-V 特定编译标志
set(RISCV_SPECIFIC_FLAGS "-march=${MOSS_RISCV_ISA}" "-mabi=${MOSS_RISCV_ABI}"
                         "-mcmodel=${MOSS_RISCV_CMODEL}" "-mstrict-align")

# RISC-V 内核特定标志
set(RISCV_KERNEL_FLAGS "-fno-pic" "-fno-pie")

# RISC-V 编译器标志已迁移到 CMakePresets.json 中的 RISC-V 预设配置 string(JOIN " "
# RISCV_FLAGS_STR ${RISCV_SPECIFIC_FLAGS} ${RISCV_KERNEL_FLAGS})
...
# RISC-V 链接器标志
set(RISCV_LINKER_FLAGS "-nostdlib" "-static" "-z max-page-size=4096")

# RISC-V 链接器标志已迁移到 CMakePresets.json 中的 RISC-V 预设配置 string(JOIN " "
# RISCV_LINKER_STR ${RISCV_LINKER_FLAGS}) set(CMAKE_EXE_LINKER_FLAGS
# "${CMAKE_EXE_LINKER_FLAGS} ${RISCV_LINKER_STR}" PARENT_SCOPE)
