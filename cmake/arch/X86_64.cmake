# X86_64 (AMD64) 架构配置 支持 Intel 和 AMD 64位处理器
...
# X86_64 内核特定标志
set(X86_64_KERNEL_FLAGS "-fno-pic" "-fno-pie" "-mcmodel=kernel")

# x86_64 编译器标志已迁移到 CMakePresets.json 中的 x86_64 预设配置 string(JOIN " "
# X86_64_FLAGS_STR ${X86_64_SPECIFIC_FLAGS} ${X86_64_KERNEL_FLAGS})
...
# X86_64 链接器标志
set(X86_64_LINKER_FLAGS "-nostdlib" "-static" "-z max-page-size=4096"
                        "-z common-page-size=4096")

# x86_64 链接器标志已迁移到 CMakePresets.json 中的 x86_64 预设配置 string(JOIN " "
# X86_64_LINKER_STR ${X86_64_LINKER_FLAGS}) set(CMAKE_EXE_LINKER_FLAGS
# "${CMAKE_EXE_LINKER_FLAGS} ${X86_64_LINKER_STR}" PARENT_SCOPE)
